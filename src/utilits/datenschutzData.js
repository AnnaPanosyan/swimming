...
export const datenschutzData = [
  ...
  Daten zu verlangen. Hierzu sowie zu weiteren Fragen zum Thema Datenschutz können 
  Sie sich jederzeit unter der im Impressum angegebenen Adresse an uns wenden. Des 
...
nicht zu Ihnen zurückverfolgt werden. Sie können dieser Analyse widersprechen 
...
`Arno Setaghyan`,
`Schwimmschule " Swimming from zero to hero" Steinmickerweg 6, 59505 Bad Sassendorf`,
 {
  name:"Telefon:",
  href:"tel:+ 49 17624310872",
  link:"+4917624310872"
 },
 {
  name:"E-Mail:",
  href:"mailto:swimmzerotohero@gmail.com",
  link:"swimmzerotohero@gmail.com"
 },
 ...
 Sie können eine bereits erteilte Einwilligung jederzeit widerrufen. Dazu reicht eine formlose
  ...
  {
    id: uuidv4(),
    title:"3. Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)",
    text:[`Wenn die Datenverarbeitung auf Grundlage von Art. 
    6 Abs. 1 lit. e oder f DSGVO erfolgt, haben Sie jederzeit das Recht, 
...
die Adresszeile des Browsers von “http://” auf “https://” wechselt und an dem Schloss-Symbol in Ihrer Browserzeile.
...
werden diese in dieser Datenschutzerklärung gesondert behandelt.`,`Server-Log-Dateien`,
...
der die Verarbeitung von Daten zur Erfüllung eines Vertrags oder vorvertraglicher Maßnahmen gestattet.`,`Kontaktformular
...
Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.`,`Die Verarbeitung der in das Kontaktformular 
eingegebenen Daten erfolgt somit ausschließlich auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO). 
...
Speicherung widerrufen oder der Zweck für die Datenspeicherung entfällt (z.B. nach abgeschlossener 
  Bearbeitung Ihrer Anfrage). Zwingende 
gesetzliche Bestimmungen - insbesondere Aufbewahrungsfristen - bleiben unberührt.`,
  ...
  },
  {
    ...
    text:[`Browser Plugin`,`Sie können die Speicherung der Cookies durch eine entsprechende 
    Einstellung Ihrer Browser-Software verhindern; wir weisen Sie jedoch darauf hin, dass 
    Sie in diesem Fall gegebenenfalls nicht sämtliche Funktionen dieser Website vollumfänglich 
    werden nutzen können. Sie können darüber hinaus die Erfassung der durch den Cookie erzeugten 
