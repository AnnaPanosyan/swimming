...
export const data = [
  ...
  },
  {
    ...
    {
      rouls: [`Sprung Kopfwärts vom Beckenrand und 20 Minuten Schwimmen. In dieser Zeit sind mindestens 
      ...
      m in der anderen Körperlage ( Wechsel der Körperlage während des Schwimmens auf der Schwimmbahn 
        ohne Festhalten)`, `zweimal ca. 2 m Tieftauchen von der Wasseroberfläche mit Heraufholen je eines 
        Gegenstandes (z.B kleiner Tauchring)`, `10 m Streckentauchen mit Abstoßen vom Beckenrand im Wasser.`,
    ...
    {
      rouls: [`Sprung Kopfwärts vom Beckenrand und 30 Minuten Schwimmen. In dieser Zeit sind mindestens 
      ...
      150 m in der anderen Körperlage (Wechsel der Körperlage während des Schwimmens auf der Schwimmbahn 
        ohne Festhalten)`, `Startsprung und 25 m Kraulschwimmen`, `Startsprung und 50 m Brustschwimmen in 
